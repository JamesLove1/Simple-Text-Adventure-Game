...
class ExtendedTests {
    ...
    @BeforeEach
    void setup() {
        final File entitiesFile = Paths.get("config" + File.separator + "extended-entities.dot").toAbsolutePath().toFile();
        final File actionsFile = Paths.get("config" + File.separator + "extended-actions.xml").toAbsolutePath().toFile();
    ...
    void test1Step2() {
        ...
        String test = sendCommandToServer("test: look");
        assertTrue(response2.contains("path not present"),
    ...
    void test1Step3() {
        ...
        assertTrue(response3.contains("added item: key to inventory"),
            "normal play-through of game should behave as expected");
    }
    ...
    void test1Step6() {
        ...
        assertTrue(response6.contains("Moved player too - cellar : A dusty cellar"),
            "normal play-through of game should behave as expected");
    }
    ...
    void test1Step14() {
        ...
        assertTrue(response14.contains("Inventory is empty"),
            "normal play-through of game should behave as expected");
    }
    ...
    void extraEntityTest() {
        ...
        final String response5 = sendCommandToServer("test: open trapdoor with key " +
            "and potion");
        assertTrue(response5.contains("extrenous Entites present within command"),
    ...
    void testBurningBridge() {
        ...
        final String response7 = sendCommandToServer("Alex: burn down route from " +
            "riverbank");
        assertEquals("no command exsits", response7,
    ...
    void testInvalidAction() {
        ...
        assertEquals("no command exsits",
            response1,
    ...
    void testAmbiguousSingleWordTriggers() {
        ...
        assertEquals("no command exsits", response1,
    ...
    void testImpossibleSubject() {
        ...
        assertEquals("no command exsits", response1, "Should not be able to perform this " +
